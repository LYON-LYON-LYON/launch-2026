...
const DATA_ASOF = "2026-09-15";   // 数据整理基准日期
const SOURCES = {
...
const EVENTS = [
  ...
  /* ===== 9月（计划/预告） ===== */
  {id:"m9-1", name:"千帆极轨16组（日期待定）", s:"", e:"", t:"待定", rk:"长征八号甲 · 遥十一", rkKey:"cz8a", pl:"千帆极轨16A-T组网卫星", satCount:0, site:"海南商业航天发射场", op:"垣信卫星 · 千帆星座", opKey:"yuanxin", cat:"yuanxin", ty:"国发", st:"plan", tbd:1, month:9, hl:1, src:"est", note:"原定 9/12。经 LL（slipped to Sep 30 00:00 UTC、状态改 To Be Determined）与垣信官方口径（9/13 浦江创新论坛称千帆累计 238 颗，与 9/5 持平，期间无千帆发射）确认未发射、已推迟，新窗口未定。载荷名无官方源（LL 标 Unknown Payload）。注：「海南商业航天发射场」与「文昌」为同一地点。"},
  ...
  {id:"m9-1d", name:"西昌任务（载荷未公布·日期待定）", s:"", e:"", t:"待定", rk:"长征三号乙（遥号待确认）", rkKey:"cz3b", pl:"未公布", satCount:0, site:"西昌卫星发射中心", op:"国家任务", opKey:"", cat:"other", ty:"国发", st:"plan", tbd:1, month:9, hl:0, src:"tbd", note:"原挂 9月10日，经核：国际源（Launch Library 2.2）西昌无任何已排定发射，且 9/10 当日全球仅长二丁/远征三号@酒泉一发（不同任务不同发射场）；原始中文计划表仅称「2026年9月」未给具体日期，该 9-10 属月度推测占位。故移除日期改为待定（tbd:1, month:9），待官方公布后回填。补充：截至 2026-09-14 西昌仍无排期（LL2 manifest 无西昌排定发射）；遥号 117 与 120 两份中文计划表互相冲突、无官方源绑定，暂不锁定遥号，记为「长征三号乙（遥号待确认）」。"},
  ...
  {id:"kp-m9-1", name:"Kuiper Sat 82-108（计划·一箭27星）", s:"", e:"", t:"待定", rk:"Vulcan Centaur", rkKey:"vulcan", pl:"Project Kuiper ×27", satCount:0, site:"佛州卡角·41号工位", op:"亚马逊·Kuiper", opKey:"kuiper", cat:"amazon", ty:"国外", st:"plan", tbd:1, month:9, hl:0, src:"tbd", note:"原记 9/15；经核国际源（Launch Library 2.2）9/15 无 Vulcan 排期，Amazon Leo（原 Project Kuiper）实际 net=2026-09-30、status=TBD、精度为月（月度精度不可当日期用），故移除日期改待定（tbd:1, month:9）。另注：国际源任务描述称每发 Vulcan 载 45 星，与库内原记口径不同，星数待核实，本次未采用。"},
  ...
  {id:"m9-6", name:"遥感五十三号01-03星 · 遥感五十六号01-03星", s:"2026-09-10", e:"2026-09-10", t:"17:00", rk:"长征四号乙", rkKey:"cz4b", pl:"遥感五十三号01~03星 + 遥感五十六号01~03星（一箭六星）", satCount:6, site:"酒泉卫星发射中心", op:"航天科技集团八院（上海航天）", opKey:"", cat:"other", ty:"国发", st:"done", hl:0, src:"xinhua", note:"原记长征二号丁·远征三号 / 载荷未公布 / 吉利07A-L，经中国日报、央视新闻、中国航天报与 Launch Library 状态变更四源核实，实为长征四号乙发射遥感五十三号01-03星、遥感五十六号01-03星，一箭六星，2026-09-10 17:00 酒泉发射成功，长征系列第 666 次发射。原载荷名「吉利07A-L」仅见于中文民间计划表、无官方来源，不予采信。"},
  {id:"m9-7", name:"朱雀二号改进型（载荷待公布·疑千帆）", s:"2026-09-15", e:"2026-09-15", t:"14:25", rk:"朱雀二号改进型", rkKey:"zq2", pl:"未公布（LL 注 Possibly a batch of SpaceSail LEO communication satellites，疑为千帆）", satCount:0, site:"酒泉卫星发射中心 LA-96A", op:"蓝箭航天", opKey:"", cat:"other", ty:"商发", st:"plan", hl:0, src:"est", note:"LL 排期 net=2026-09-15T06:25Z（北京 14:25），酒泉 LA-96A。若载荷确为千帆，将是蓝箭首次承担星座组网发射。载荷未官宣。补充（2026-09-15 09:10 北京核）：发射窗口 14:18–14:40（计划起飞 14:25，与 t 字段一致）。多源（东方财富 9/14、科舟纪元、小红书）称载荷为千帆星座正式组网卫星，若属实将是民营商业火箭首次执行巨型星座批量组网发射；但蓝箭官方尚未官宣，国际源仍记「Possibly」。星数全源未公布（坊间 10 颗 / 18 颗等说法均属猜测），故 satCount 保持 0、不得填。遥号存在冲突：东方财富称 ZQ-2E 遥七（Y7），航天日报与科舟纪元称「遥九」（系列第 9 次发射），待核实；本库 rk 字段本就不写遥号，不受影响。轨道：中文源称极轨 / SSO，国际源记 Unknown。截至北京 2026-09-15 09:10 尚未到发射窗口，st 保持 plan。"},
  {id:"m9-3", name:"千帆星座（引力一号·遥三·一箭9星）", s:"2026-09-16", e:"2026-09-16", t:"05:55", rk:"引力一号 · 遥三", rkKey:"yyl1", pl:"未公布（民间推测为千帆星座，星数未官宣）", satCount:0, site:"山东海阳附近海域（东方航天港·海上发射）", op:"垣信卫星 · 千帆星座", opKey:"yuanxin", cat:"yuanxin", ty:"国发", st:"plan", hl:0, src:"est", note:"原记 9/14 05:30 山东海阳；经央视网、证券时报、每日经济新闻与 LL（net=2026-09-15T21:55Z）四源确认改期至 9/16 上午（北京 05:55）。海阳既是箭体总装出厂/出港地，也是海上发射母港，实际发射点在其附近海域。海域名称两源冲突：国内民间计划表记「东海」，LL 的 pad 字段记「Yellow Sea (launch location 5)」即黄海（与海阳市濒临黄海的地理位置一致）。本站不采信任一单一源，改用官方惯用的中性表述「山东海阳附近海域」，最终以官方发射通告为准。载荷官方未公布。补充（2026-09-15 核）：官方口径（「海阳发布」，经央视网 9/13、证券时报 9/13、每日经济新闻 9/14 转载）仅称「9月16日上午」，未给具体时刻，本条 t 字段的 05:55 系国际源（Launch Library 2.2）值，最终以官方发射通告为准。"},
  ...
  {id:"m9-5", name:"快舟十一号（9月·计划）", s:"2026-09-17", e:"2026-09-17", t:"10:35", rk:"快舟十一号", rkKey:"kz11", pl:"载荷待公布", satCount:0, site:"酒泉卫星发射中心", op:"航天科工", opKey:"", cat:"other", ty:"商发", st:"plan", hl:0, src:"est", note:"原记 9/28；据 LL 调整为 9/17 10:35 北京、酒泉 LA-95A，以官方通告为准。载荷待公布。补充（2026-09-15 核）：该日期为行业内部预测，尚无官方通告，存在取消或推迟可能。"},
